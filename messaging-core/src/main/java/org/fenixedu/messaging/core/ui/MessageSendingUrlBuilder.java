...
public class MessageSendingUrlBuilder {
    private final UriBuilder builder =
            UriBuilder.fromPath(CoreConfiguration.getConfiguration().applicationUrl() + "/messaging/message");
    ...
    public MessageSendingUrlBuilder bccs(String bccs) {
        builder.queryParam("bccs",
                MessagingSystem.Util.toEmailSet(bccs).stream().map(MessageSendingUrlBuilder::encode).toArray());
        return this;
    }
